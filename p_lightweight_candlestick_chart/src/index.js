...
function App() {
  ...
  // useEffect(() => {
  //   fetch("https://api.wazirx.com/sapi/v1/ticker/24hr?symbol=wrxinr").then(d=>d.json().then(d=>{setStock([{time: "2018-12-28" , open: d.openPrice , high: d.highPrice , low: d.lowPrice , close: d.lastPrice}])}))
  // }, [])
  // console.log(stock);
